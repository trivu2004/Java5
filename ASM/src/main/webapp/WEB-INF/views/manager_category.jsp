...
<body>
<form:form modelAttribute="categoryItem" method="post" class="me-auto ms-auto w-50 mt-3 row">
    ...
    <div class="mb-3">
        <form:input path="categoryName" type="text" placeholder="Category Name" class="form-control"/>
        <form:errors path="categoryName" class="form-text text-danger" />
    </div>
    <div>
        <div class="float-end">
