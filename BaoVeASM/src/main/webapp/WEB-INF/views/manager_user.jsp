...
<form:form modelAttribute="accountItem" method="post" class="me-auto ms-auto w-50 mt-3 row border border-3 border-white rounded p-5">
    <h1 class="text-primary-emphasis text-center mb-2">User Management- CRUD</h1>
    <h5 class="text-primary-emphasis text-center mb-4">fill in data below</h5>
    ...
    <div class="mb-3">
        <form:input path="username" type="text" placeholder="Name" class="form-control"/>
...
<table class="table table-light table-hover me-auto ms-auto w-50 mt-3 text-center ">
    ...
    <tr class="bg-primary-subtle">
        <th scope="col" class="bg-primary-subtle">ID</th>
        <th scope="col" class="bg-primary-subtle">Name</th>
        <th scope="col" class="bg-primary-subtle">Password</th>
        <th scope="col" class="bg-primary-subtle">Fullname</th>
        <th scope="col" class="bg-primary-subtle">Vai Trò</th>
        <th scope="col" class="bg-primary-subtle">Action</th>
        <th scope="col" class="bg-primary-subtle">Edit</th>
    </tr>
    </thead>
    <tbody>
